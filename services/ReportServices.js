...
class ReportServices {
  ...
  async ReportSingleAnimal(activities, author, options) {
          ...
          [
            ...
            },
            {
              table: {
                headerRows: 1,
                body: [
                  [{ text: `${author.petName}`, colSpan: 2, alignment: 'center', style: 'columnsTitle', marginTop: 2, marginLeft: 10, fillColor: '#f75f60' }, {}],
                  [{ text: `Nascimento: ${author.petBirth.toJSON().slice(0, 10)}`, marginLeft: 10, marginRight: 60, marginTop: 10 }, { text: `Vacinação: ${author.petVaccCard ? "Sim" : "Não"}`, marginRight: 60, marginTop: 10 }],
    ...
    const activitiesInformation = [{ text: "\n\n Atividades na última semana: \n\n", style: "SectionTitle" },
    ...
    const docDefinition = {
      ...
      content: [
        ...
        // PERFIL
        options.includes("profile") ? profileInformation : { text: "", marginTop: 10 },
        ,
        // STATUS 
        options.includes("status") ? statusInformation : { text: "", marginTop: 10 },
        ,
        // ATIVIDADES
        options.includes("activities") ? activitiesInformation : { text: "", marginTop: 10 },
      ],
          ...
          table: {
            ...
            body: [
              ...
              [
                ...
                { text: `Relatório gerado em ${new Date().toLocaleDateString('pt-BR')} às ${new Date().toLocaleTimeString('pt-BR', { hour: '2-digit', minute: '2-digit' })}` , alignment: 'left', margin: [0, 0, 70, 0] }
              ]
            ]
          },
        }
