                            ...
                            },
                            {
                                table: {
                                    ...
                                    body: [
                                        ...
                                        [ {text: `Nascimento: ${author.petBirth.toJSON().slice(0,10)}`, marginLeft:10, marginRight:60}, {text: `Vacinação: ${author.petVaccCard}`, marginRight:60}],
